...
export default function PgpKey() {
	...
	<div className="hidden md:grid grid-cols-5 ">
		<button
		className="mb-20 col-start-3 mt-5  h-10 border-2 rounded-lg border-white    hover:bg-gray-400 cursor-pointer"
	...
	<div className="md:hidden z-20 relative">
		<button
		className="mb-20 block mx-auto  mt-5 w-64 h-10 border-2 rounded-lg border-white   hover:bg-gray-400 cursor-pointer"
